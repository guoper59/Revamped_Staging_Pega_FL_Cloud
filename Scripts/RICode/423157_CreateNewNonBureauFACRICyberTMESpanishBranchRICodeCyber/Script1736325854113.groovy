 ...
 * ============================================================================
 * Test Case ID : 423157
 * Title         : Create New Non Bureau FACRI Cyber TME Spanish Branch RI Code Cyber
 * Folder        : Scripts/RICode/423157_CreateNewNonBureauFACRICyberTMESpanishBranchRICodeCyber
 * ============================================================================
 *
 * DESCRIPTION:
...
WebUI.sendKeys(findTestObject('Object Repository/NewBusiness/input_SublimitSingle'), Keys.chord(Keys.TAB))
...
WebUI.waitForElementVisible(findTestObject('Object Repository/NewBusiness/button_SubmitPostBind'), 60,
	FailureHandling.STOP_ON_FAILURE)

WebUI.enhancedClick(findTestObject('Object Repository/NewBusiness/button_SubmitPostBind'))
...
if (RefDescription.contains('GCY')) {
