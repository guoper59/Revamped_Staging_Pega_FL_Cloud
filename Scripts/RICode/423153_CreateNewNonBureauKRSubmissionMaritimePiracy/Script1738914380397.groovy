 ...
 * Folder        : Scripts/RICode/423153_CreateNewNonBureauKRSubmissionMaritimePiracy
 * ============================================================================
 *
 * DESCRIPTION:
...
WebUI.enhancedClick(findTestObject('Object Repository/Pega_CreateInsured/Page_PegaCaseManagerPortal/btn_SearchName'))
...
WebUI.scrollToElement(findTestObject('Object Repository/NewBusiness/button_AddItemKR'), GlobalVariable.timeOutValue)
...
WebUI.scrollToElement(findTestObject('Object Repository/NewBusiness/button_FinalTakeUpQuote'), 25)
...
WebUI.scrollToElement(findTestObject('Object Repository/NewBusiness/button_Continue'), 25, FailureHandling.OPTIONAL)
...
if (RefDescription.contains('PIR')) {
