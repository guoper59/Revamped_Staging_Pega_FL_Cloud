 ...
 * ============================================================================
 * Test Case ID : 423160
 * Title         : Createa Safety National Policywithinceptiondateinyear20YY
 * Folder        : Scripts/RICode/423160_CreateaSafetyNationalPolicywithinceptiondateinyear20YY
 * ============================================================================
 *
 * DESCRIPTION:
...
WebUI.sendKeys(findTestObject('Object Repository/NewBusiness/input_FieldName', [('fieldName') : 'Master Policy Reference/ AIM ID ']), findTestData(testData).getValue('MasterPolicyRef', rowNumber))

WebUI.click(findTestObject('Object Repository/NewBusiness/select_DynamicDropDown', [('dropDownLabel') : 'Master Office']))

WebUI.selectOptionByLabel(findTestObject('Object Repository/NewBusiness/select_DynamicDropDown',
[('dropDownLabel') : 'Master Office']), findTestData(testData).getValue('MasterOffice', rowNumber),false)
...
WebUI.scrollToElement(findTestObject('Object Repository/NewBusiness/button_Continue'), 20)
...
if (RefDescription.contains('SNP')) {
