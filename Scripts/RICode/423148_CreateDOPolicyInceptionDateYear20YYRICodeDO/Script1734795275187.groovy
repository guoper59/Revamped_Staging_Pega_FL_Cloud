 ...
 * ============================================================================
 * Test Case ID : 423148
 * Title         : Create DO Policy Inception Date Year20YYRI Code DO
 * Folder        : Scripts/RICode/423148_CreateDOPolicyInceptionDateYear20YYRICodeDO
 * ============================================================================
 *
 * DESCRIPTION:
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Pega_CreateInsured/Page_PegaCaseManagerPortal/webElement_Continue'), 60, FailureHandling.OPTIONAL)
...
if (RefDescription.contains('GDO')) {
