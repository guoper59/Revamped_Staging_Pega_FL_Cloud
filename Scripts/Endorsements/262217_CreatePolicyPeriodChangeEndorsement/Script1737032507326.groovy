...
WebUI.verifyElementPresent(findTestObject('Object Repository/NewBusiness/webElement_OpenQuote'), 180, 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Test Cases/Endorsements/262217_CreatePolicyPeriodChangeEndorsement_SubTestCase_Part0'), [('testData') : testData, ('rowNumber') : rowNumber],
	FailureHandling.STOP_ON_FAILURE)
