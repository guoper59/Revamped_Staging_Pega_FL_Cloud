 ...
 * Folder        : Scripts/Endorsements/300727_CreateAdditionalpremiumendorsementonaBordereauFacilitySubmissionNew
 * ============================================================================
 *
 * DESCRIPTION:
...
WebUI.click(findTestObject('Object Repository/NewBusiness/input_FieldName', [('fieldName') : 'Primary Total Layer Limit']))
...
WebUI.waitForElementClickable(findTestObject('Object Repository/OutwardsPolicy/button_Approve'), 25)
...
String endorsementNumber2 = WebUI.callTestCase(findTestCase('Test Cases/TestData/300727_CreateReturnPremiumEndorsement'), [('version') : 2],
	FailureHandling.STOP_ON_FAILURE)

KeywordUtil.logInfo(endorsementNumber2)

//Validate the Endorsement Details in Response
WebUI.callTestCase(findTestCase('Test Cases/TestData/300727_ValidateEndorsementDetails'), [('testData') : testData , ('rowNumber') : rowNumber], FailureHandling.STOP_ON_FAILURE)
