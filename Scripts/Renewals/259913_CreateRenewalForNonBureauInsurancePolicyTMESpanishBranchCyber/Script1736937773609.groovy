 ...
 * Folder        : Scripts/Renewals/259913_CreateRenewalForNonBureauInsurancePolicyTMESpanishBranchCyber
 * ============================================================================
 *
 * DESCRIPTION:
...
WebUI.verifyElementNotChecked(findTestObject('Object Repository/Documentation/PolicyCreation/input_DynamicValuesCheckbox', 
        [('labelName') : 'Additional Insureds']), 25)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/NewBusiness/button_Finalise'), 60, 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/NewBusiness/button_Finalise'))

WebUI.click(findTestObject('Object Repository/NewBusiness/button_Finalise'), FailureHandling.OPTIONAL)
...
WebUI.switchToFrame(findTestObject('Object Repository/Dashboards/iframe_PegaGadget0Ifr'), 25, FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Dashboards/button_ExportToExcel'), 25)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Dashboards/webElement_ClearFilter'), 25, 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Dashboards/webElement_QuoteReference'), 25, 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Dashboards/webElement_QuoteReference'))

WebUI.switchToFrame(findTestObject('Object Repository/Dashboards/iframe_PegaGadget1Ifr'), 25)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/OutwardsPolicy/button_LogOff'), 25)

WebUI.click(findTestObject('Object Repository/OutwardsPolicy/button_LogOff'))

WebUI.callTestCase(findTestCase('Test Cases/Renewals/259913_SubTestCase_Part1'), [('testData') : testData, ('rowNumber') : rowNumber
        , ('policyRef') : policyRef], FailureHandling.STOP_ON_FAILURE)

GlobalVariable.PolicyRef = GlobalVariable.RenewedPolicy

WebUI.callTestCase(findTestCase('Test Cases/Eclipse/259913_EclipseValidation'), [('testData') : testData, ('rowNumber') : rowNumber], 
    FailureHandling.STOP_ON_FAILURE)