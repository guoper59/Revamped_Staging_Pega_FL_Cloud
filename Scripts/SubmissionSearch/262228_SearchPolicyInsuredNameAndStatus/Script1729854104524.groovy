 ...
 * ============================================================================
 * Test Case ID : 262228
 * Title         : Search Policy Insured Name And Status
 * Folder        : Scripts/SubmissionSearch/262228_SearchPolicyInsuredNameAndStatus
 * ============================================================================
 *
 * DESCRIPTION:
...
String PolicyRef = WebUI.callTestCase(findTestCase('Test Cases/TestData/CreateSubmission'), [:], FailureHandling.STOP_ON_FAILURE)
...
GenericUtils.verifyMatch('Policy Reference is matched', actualPolicyRef, PolicyRef, 'EQUAL')