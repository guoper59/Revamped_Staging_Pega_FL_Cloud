 ...
 * ============================================================================
 * Test Case ID : 262210
 * Title         : Program View Search POSI And DNO Single Or Multiple Programme ID
 * Folder        : Scripts/SubmissionSearch/262210_ProgramViewSearchPOSIAndDNOSingleOrMultipleProgrammeID
 * ============================================================================
 *
 * DESCRIPTION:
...
WebUI.verifyElementClickable(findTestObject('Object Repository/Page_PegaCaseManagerPortal/webElement_InsuredName', [('insuredName') : findTestData(
...
WebUI.waitForElementVisible(findTestObject('Page_PegaCaseManagerPortal/webElement_MajorClass', [('majorClass') : findTestData(
                testData).getValue('Major Class', rowNumber)]), GlobalVariable.timeOutValue)

WebUI.click(findTestObject('Object Repository/Page_PegaCaseManagerPortal/webElement_MajorClass', [('majorClass') : findTestData(
                testData).getValue('Major Class', rowNumber)]))

WebUI.click(findTestObject('Object Repository/Page_PegaCaseManagerPortal/button_OK'))
//TODO: Click on "More Filters" to expand the rest of the filters
...
for (int i = 0; i < rowcount.size(); i++) {
    ...
    WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_PegaCaseManagerPortal/select_DropdownProgrammeView'), 
        findTestData(testData).getValue('ProgrammeView', rowcount.get(i)), false)
    ...
    WebUI.verifyElementPresent(findTestObject('Object Repository/Page_PegaCaseManagerPortal/webElement_forValidation', [
                ('fieldName') : 'Multi LOB Id']), GlobalVariable.timeOutValue, FailureHandling.STOP_ON_FAILURE)

    WebUI.verifyElementPresent(findTestObject('Object Repository/Page_PegaCaseManagerPortal/webElement_forValidation', [
                ('fieldName') : 'Single LOB Id']), GlobalVariable.timeOutValue, FailureHandling.STOP_ON_FAILURE)
    ...
    WebTableUtils.verifytableValues(findTestObject('Object Repository/Page_PegaCaseManagerPortal/Pega_SubmissionSearch/webElement_tableSubmissionSearchResults'), 
        'Insured Name', findTestData(testData).getValue('Insured Name', rowNumber))
...
String multiLOBID_POSI = WebUI.getText(findTestObject('Page_PegaCaseManagerPortal/Pega_SubmissionSearch/webElement_MultiLOBID',
		[('minorClass') : 'POSI']))

print(multiLOBID_POSI)

String multiLOBID_NonPOSI = WebUI.getText(findTestObject('Object Repository/Page_PegaCaseManagerPortal/Pega_SubmissionSearch/webElement_MultiLOBID',
		[('minorClass') : 'Side A + B + C']))

if (multiLOBID_POSI != multiLOBID_NonPOSI) {
	KeywordUtil.markFailed(((multiLOBID_POSI + ' and ') + multiLOBID_NonPOSI) + ' do not match.')
}