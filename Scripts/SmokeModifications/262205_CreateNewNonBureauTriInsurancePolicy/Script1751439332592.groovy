 ...
 * Folder        : Scripts/SmokeModifications/262205_CreateNewNonBureauTriInsurancePolicy
 * ============================================================================
 *
 * DESCRIPTION:
...
WebUI.scrollToElement(findTestObject('Object Repository/Pega_CreateInsured/Page_PegaCaseManagerPortal/webElement_Broker'), GlobalVariable.timeOutValue)
...
GenericUtils.verifyMatch('Entity Value is', licenceState, stateValue, 'EQUAL')

String licenceNumber = WebUI.getText(findTestObject('Object Repository/NewBusiness/webElement_SelectedDropDownOption', [
			('dropDownName') : 'Number']))
...
WebUI.waitForElementPresent(findTestObject('Object Repository/NewBusiness/webElement_GenerateInstallmentsMessage'), 60)
...
WebUI.enhancedClick(findTestObject('Object Repository/OutwardsPolicy/webElement_CaseContentsOptions', [('linkToClick') : 'Bind Policy']))
