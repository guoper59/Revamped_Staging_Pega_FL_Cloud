...
WebUI.scrollToElement(findTestObject('Object Repository/UnderwritingWorksheet/webElement_DynamicLOBSpecificTabs', [('headerName') : 'Programme Structure and Authority',('tabName') : 'Directors & Officers´ Liability']), GlobalVariable.timeOutValue)

WebUI.click(findTestObject('Object Repository/UnderwritingWorksheet/webElement_DynamicLOBSpecificTabs', [('headerName') : 'Programme Structure and Authority',('tabName') : 'Directors & Officers´ Liability']))
...
WebUI.scrollToElement(findTestObject('Object Repository/UnderwritingWorksheet/webElement_DynamicLOBSpecificTabs', [('headerName') : 'Programme Structure and Authority',('tabName') : 'Professional Indemnity']), GlobalVariable.timeOutValue)

WebUI.click(findTestObject('Object Repository/UnderwritingWorksheet/webElement_DynamicLOBSpecificTabs', [('headerName') : 'Programme Structure and Authority',('tabName') : 'Professional Indemnity']))
