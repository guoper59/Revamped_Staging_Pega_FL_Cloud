 ...
 * Folder        : Scripts/ViewMode/259889_ViewPolicyOnClickOnInsuredLinkFromSubmissionSearch
 * ============================================================================
 *
 * DESCRIPTION:
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_PegaCaseManagerPortal/Pega_SubmissionSearch/webElement_VerifyTabHeaders'),  GlobalVariable.timeOutValue, FailureHandling.STOP_ON_FAILURE)

List<WebElement> tabs=WebUI.findWebElements(findTestObject('Object Repository/Page_PegaCaseManagerPortal/Pega_SubmissionSearch/webElement_VerifyTabHeaders'), GlobalVariable.timeOutValue)
...
//verify Tab Headers
GenericUtils.compareLists(actualHeaders,expectedHeaders)
