/**
 * ============================================================================
 * Title        : GetPolicyEnquirySBS
 * Title         : GetPolicyEnquirySBS
 * Folder        : Scripts/Eclipse/GetPolicyEnquirySBS
 * ============================================================================
 *
 * DESCRIPTION:
...
ResponseObject response = WS.sendRequest(findTestObject('Eclipse_APIs/GetPolicyEnquirySBS'))
