/**
 * ============================================================================
 * Title        : GetPaymentStatusCF
 * Title         : GetPaymentStatusCF
 * Folder        : Scripts/Eclipse/GetPaymentStatusCF
 * ============================================================================
 *
 * DESCRIPTION:
...
ResponseObject response = WS.sendRequest(findTestObject('Eclipse_APIs/GetPaymentStatusCF'))
