/**
 * ============================================================================
 * Title        : GetClaimsEnquirySBS
 * Title         : GetClaimsEnquirySBS
 * Folder        : Scripts/Eclipse/GetClaimsEnquirySBS
 * ============================================================================
 *
 * DESCRIPTION:
...
ResponseObject response = WS.sendRequest(findTestObject('Eclipse_APIs/GetClaimsEnquirySBS'))
