/**
 * ============================================================================
 * Title        : GetSearchSubmissionsSIMS
 * Title         : GetSearchSubmissionsSIMS
 * Folder        : Scripts/Eclipse/GetSearchSubmissionsSIMS
 * ============================================================================
 *
 * DESCRIPTION:
...
ResponseObject response = WS.sendRequest(findTestObject('Eclipse_APIs/GetSearchSubmissionsSIMS'))
